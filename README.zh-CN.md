...
![可视化 TOC 与 PDF 原文预览](./docs/assets/screenshot-toc-preview.png)

PageChat 会先构建可导航的 TOC，再进入问答流程，用户可以直接检查文档结构并跳回页级原文证据。

![绑定文档上下文的 Chat 工作台](./docs/assets/screenshot-chat-workspace.png)

Chat 工作台可以把对话限定到选中的文档、文件夹、截图或网页上下文，同时展示工具执行过程和可追溯回答。
